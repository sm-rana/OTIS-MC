...
* MINOR MODIFICATION: I added NREACH and LASTSEG in the arg list of the function
************************************************************************
      SUBROUTINE INPUT(TSTEP,TSTART,TFINAL,IPRINT,XSTART,DSBOUND,
     &   PRTOPT,
...
*
      ...
      CALL INPUT2(IMAX,DISP,AREA2,ALPHA,XSTART,DELTAX,NREACH,
     &                  LASTSEG, nseg, rchlen)
      !write(*,*) "INPUT.f: NREACH = ",NREACH
*
