...
Rvgs::Rvgs(int seed) {
	sfmt_init_gen_rand(&sfmt, (uint32_t)seed);
}
...
long Rvgs::Binomial(long n, double p)
	/* ================================================================ 
...
long Rvgs::Equilikely(long a, long b)
	/* ===================================================================
...
long Rvgs::Pascal(long n, double p)
	/* ================================================= 
...
double Rvgs::Uniform(double a, double b)
	/* =========================================================== 
...
double Rvgs::Exponential(double m)
	/* =========================================================
...
double Rvgs::Erlang(long n, double b)
	/* ================================================== 
...
double Rvgs::Normal(double m, double s)
	/* ========================================================================
...
double Rvgs::Lognormal(double a, double b)
	/* ==================================================== 
...
double Rvgs::Lognormal2(double expectation, double stddev) {
	/* return a lognormal distributed real number with given expectation 
	and standard deviation*/

	double mu, sigma2;
	sigma2 = log(1 + (stddev/expectation)*(stddev/expectation));
	mu = log(expectation) - 0.5 * sigma2;
	return exp(mu + sqrt(sigma2) * Normal(0.0, 1.0));
}


double Rvgs::Chisquare(long n)
	/* =====================================================
